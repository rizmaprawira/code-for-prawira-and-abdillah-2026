#!/bin/csh -f
# Moist execution runner for EXP_B_S-123

set ROOT = "/Users/rizzie/LinearBaroclinicModel/experiment/ncep_r2_moist_experiment/EXP_B_S-123"
...
cat << END_OF_DATA >! SYSIN
 &nmrun  run='moist linear model: EXP_B_S-123'                     &end
