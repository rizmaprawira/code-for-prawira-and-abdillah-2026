#!/bin/csh -f
# Moist execution runner for EXP_B_S-12

set ROOT = "/Users/rizzie/LinearBaroclinicModel/experiment/ncep_r2_moist_experiment/EXP_B_S-12"
...
setenv FRC "../frc/p2_s12/frcsst.p2_s12.t21.grd"
setenv SFRC "../frc/p2_s12/frcsst.p2_s12.t21.grd"
...
cat << END_OF_DATA >! SYSIN
 &nmrun  run='moist linear model: EXP_B_S-12'                     &end
