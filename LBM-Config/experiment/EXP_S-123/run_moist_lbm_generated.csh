#!/bin/csh -f
# Moist execution runner for EXP_S-123

set ROOT = "/Users/rizzie/LinearBaroclinicModel/experiment/ncep_r2_moist_experiment/EXP_S-123"
...
setenv DATS "../bs/gt3/p1/sstwin.t21"
setenv DATW "../bs/gt3/wgwin.t21"
setenv DATI "../bs/gt3/gridx.t21"
setenv BSFILE "../bs/gt3/p1/atm_basic_state.t21l20"
setenv FRC "../frc/p2/frcsst.p2.t21.grd"
setenv SFRC "../frc/p2/frcsst.p2.t21.grd"
...
cat << END_OF_DATA >! SYSIN
 &nmrun  run='moist linear model: EXP_S-123'                     &end
