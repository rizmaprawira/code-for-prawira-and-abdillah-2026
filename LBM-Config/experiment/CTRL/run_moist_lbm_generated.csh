#!/bin/csh -f
# Moist execution runner for CTRL

set ROOT = "/Users/rizzie/LinearBaroclinicModel/experiment/ncep_r2_moist_experiment/CTRL"
...
setenv FRC "../frc/p1/frcsst.p1.t21.grd"
setenv SFRC "../frc/p1/frcsst.p1.t21.grd"
...
cat << END_OF_DATA >! SYSIN
 &nmrun  run='moist linear model: CTRL'                     &end
